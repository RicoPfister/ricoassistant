...
<div v-if="1" class="flex flex-col my-2">
    ...
    <div class="">
        <div class="flex justify-between">
            <div class="font-bold bg-red-200 w-full mb-2">Images</div>
        </div>

        <div class="border-b-2 border-black font-bold">Image List</div>
    ...
    <div class="pt-2 w-full">
        <div v-for="(item, index) in props.detail.sourceData.tag" class="flex flex-row flex-wrap">
    ...
    <div class="flex flex-wrap mt-1 gap-1">
        <div v-for="(item, index) in props.controllerFilesImage" class="">
...
const props = defineProps(['detail', 'controllerFilesImage', 'volumeActive']);
