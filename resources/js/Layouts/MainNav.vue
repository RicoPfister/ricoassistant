                ...
                <div aria-label="search box" class="xl:relative xl:w-full flex xl:justify-end w-full items-center">
                    ...
                    <div aria-label="quickbar" class="absolute flex left-0 top-[53px] xl:top-12 xl:gap-6 gap-2 w-full justify-center xl:justify-start text-sm xl:text-lg">
                        <div class="flex items-center">
                            ...
                            <Link :href="route('search')" class="underline flex flex-row"><span class="hidden 2xl:block">999k&nbsp;</span><b>Facts</b></Link>
                        </div>
                        <div class="flex items-center">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-4 h-4 mr-1">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M12 18v-5.25m0 0a6.01 6.01 0 001.5-.189m-1.5.189a6.01 6.01 0 01-1.5-.189m3.75 7.478a12.06 12.06 0 01-4.5 0m3.75 2.383a14.406 14.406 0 01-3 0M14.25 18v-.192c0-.983.658-1.823 1.508-2.316a7.5 7.5 0 10-7.517 0c.85.493 1.509 1.333 1.509 2.316V18" />
                            </svg>
                            <Link :href="route('search')" class="underline flex flex-row"><span class="hidden 2xl:block">999k&nbsp;</span><b>Opinions</b></Link>
                        </div>
                        <div class="items-center flex 2xl:hidden">
                            ...
                            <Link :href="route('search')" class="underline flex flex-row"><b>Media</b></Link>
                        </div>
                        <div class="items-center hidden 2xl:flex">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-4 h-4 mr-1">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M2.25 15.75l5.159-5.159a2.25 2.25 0 013.182 0l5.159 5.159m-1.5-1.5l1.409-1.409a2.25 2.25 0 013.182 0l2.909 2.909m-18 3.75h16.5a1.5 1.5 0 001.5-1.5V6a1.5 1.5 0 00-1.5-1.5H3.75A1.5 1.5 0 002.25 6v12a1.5 1.5 0 001.5 1.5zm10.5-11.25h.008v.008h-.008V8.25zm.375 0a.375.375 0 11-.75 0 .375.375 0 01.75 0z" />
                            </svg>
                            <Link :href="route('search')" class="underline flex flex-row"><span class="">999k&nbsp;</span><b>Pictures</b></Link>
                        </div>
                        <div class="items-center hidden 2xl:flex">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-4 h-4 mr-1">
                            ...
                            <Link :href="route('search')" class="underline flex flex-row"><span class="hidden xl:block">999k&nbsp;</span><b>Videos</b></Link>
                        </div>
                        <div class="flex items-center">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-4 h-4 mr-1">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M19.5 14.25v-2.625a3.375 3.375 0 00-3.375-3.375h-1.5A1.125 1.125 0 0113.5 7.125v-1.5a3.375 3.375 0 00-3.375-3.375H8.25M9 16.5v.75m3-3v3M15 12v5.25m-4.5-15H5.625c-.621 0-1.125.504-1.125 1.125v17.25c0 .621.504 1.125 1.125 1.125h12.75c.621 0 1.125-.504 1.125-1.125V11.25a9 9 0 00-9-9z" />
                            </svg>
                            <Link :href="route('search')" class="underline flex flex-row"><span class="hidden 2xl:block">999k&nbsp;</span><b>Accounting</b></Link>
                        </div>
                    </div>
                </div>
            </div>
