...
<path stroke-linecap="round" stroke-linejoin="round" d="M2.25 12l8.954-8.955c.44-.439 1.152-.439 1.591 0L21.75 12M4.5 9.75v10.125c0 .621.504 1.125 1.125 1.125H9.75v-4.875c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125V21h4.125c.621 0 1.125-.504 1.125-1.125V9.75M8.25 21h8.25" />
        ...
        &nbsp;>&nbsp;</div>
    <div class=""><span class="underline">Detail Entry</span></div>
  </div>
</div>
</div>
    ...
    <form aria-label="New Entry Container" class="mb-10 w-full min-w-0">
        ...
        <div class="lg:w-[755px] lg:mx-auto">
                    ...
                    <div class="flex gap-3 flex-wrap w-full min-w-0">
                        ...
                        <div class="flex flex-col min-w-0 ">
                            ...
                            <select id="subject" v-model="form.subject">
                                ...
                                <optgroup label="Admininistration:">
                                ...
                                <optgroup label="Physical:">
                                    ...
                                    <option value="self_being">Self being</option>
                                    <option value="active_being">Active being</option>
                                    <option value="passive_being">Passive being</option>
                                </optgroup>
                                <optgroup label="Misc:">
                                    <option value="focus_mix">Subject Mix</option>
                                    <option value="other_focus">Other Subject</option>
                                </optgroup>
                            </select>
                        </div>
            ...
            <div aria-label="Drop Down Statement" class="">
                ...
                <div v-if="activityOpen" class="flex flex-col p-3 border bg-gray-100">
                    <div class="flex flex-row gap-3">
                        <div class="w-36">
                            <label class="" aria-label="Statement Input" for="timeTracking">From: </label>
                            <div class="flex grow">
                                <input class="grow" id="timeTracking" type="time" v-model="form.activityFrom">
                            </div>
                        </div>
                        <div class="w-36">
                            <label class="" aria-label="Statement Input" for="timeTracking">To: </label>
                            <div class="flex grow">
                                <input class="grow" id="timeTracking" type="time" v-model="form.activityTo">
                            </div>
                        </div>
                        <div class="grow">
                            <label class="" aria-label="Statement Input" for="timeTracking">Reference: </label>
                            <div class="flex grow">
                                <input class="grow" id="timeTracking" type="text" v-model="form.activityReference">
                            </div>
                        </div>
                    </div>
                </div>
...
const props = defineProps(['basic', 'statement', 'activity', 'reference', 'tag', 'accounting', 'rating', 'documents']);
...
const form = useForm({
    ref_date: props.basic.ref_date,
    focus: props.basic.focus,
    author: props.basic.author,
    title: props.basic.title,

    statement: props.statement.statement,

    activityFrom: props.activity.activityFrom,
    activityTo: props.activity.activityTo,
    activityReference: props.activity.activityReference,

    reference: props.reference.reference,

    tag: props.tag.tag,

    accounting_producer: props.accounting.accounting_producer,
    accounting_trader: props.accounting.accounting_trader,
    accounting_price: props.accounting.accounting_price,
    accounting_currency: props.accounting.accounting_currency,
    accounting_price_default_currency: props.accounting.accounting_price_default_currency,

    rating_comparison: props.rating.rating_comparison,
    rating_happiness: props.rating.rating_happiness,
    rating_sadness: props.rating.rating_sadness,
    rating_quality: props.rating.rating_quality,
    rating_ingenuity: props.rating.rating_ingenuity,
    rating_originality: props.rating.rating_originality,
    rating_complexity: props.rating.rating_complexity,
    rating_simplicity: props.rating.rating_simplicity,
    rating_usability: props.rating.rating_usability,
    rating_versatility: props.rating.rating_versatility,
    rating_developement: props.rating.rating_developement,
    rating_sustainability: props.rating.rating_sustainability,
