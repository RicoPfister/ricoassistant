                    ...
                    <div class="flex gap-3 flex-wrap w-full min-w-0">
                        ...
                        <div class="grow">
                            <div class="relative flex flex-col grow">
                                ...
                                <!-- warning sign -->
                                <button v-if="basicTitleWarning" @click="basicTitelPickerOpen = !basicTitelPickerOpen" type="button" class="absolute top-[33px] right-0 pr-2">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" :class="{'fill-red-400': props.basicResult[0].warning == 2, 'text-black': props.basicResult[0].warning == 2}" fill="none" color="gray" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                                    ...
                                    <div class="flex flex-row items-center z-50">
                                        ...
                                        <div class="text-sm xl:text-base z-50 w-full max-h-52 overflow-y-auto">
                                            ...
                                            <div class="flex justify-between w-full">
                                                <button type="button" @click.prevent="" class="ml-1 text-gray-500 hover:text-black truncate grow text-left" :class="{'text-red-500': props.basicResult[index].warning == 2, 'hover:text-red-800': props.basicResult[index].warning == 2}" ><div class="truncate">{{ item.title }}</div></button>
                                                <button type="button" @click.prevent="" class="ml-1 text-gray-500 hover:text-black truncate" :class="{'text-red-500': props.basicResult[index].warning == 2, 'hover:text-red-800': props.basicResult[index].warning == 2}" ><div class="truncate">{{ item.ref_date }}</div></button>
                                            </div>
                                        </div>
