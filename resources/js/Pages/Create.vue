...
<path stroke-linecap="round" stroke-linejoin="round" d="M2.25 12l8.954-8.955c.44-.439 1.152-.439 1.591 0L21.75 12M4.5 9.75v10.125c0 .621.504 1.125 1.125 1.125H9.75v-4.875c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125V21h4.125c.621 0 1.125-.504 1.125-1.125V9.75M8.25 21h8.25" />
        ...
        &nbsp;>&nbsp;</div>
    <div class=""><span class="underline">New Entry</span></div>
  </div>
</div>
</div>
    ...
    <form aria-label="New Entry Container" class="mb-10 w-full min-w-0">
        ...
        <div class="lg:w-[755px] lg:mx-auto">
            ...
            <div aria-label="Drop Down Basics" class="w-full min-w-0">
                ...
                <div v-if="basicOpen" class="bg-gray-100 p-3 w-full min-w-0">
                    <div class="flex gap-3 flex-wrap w-full min-w-0">
                        ...
                        <div class="flex flex-col grow">
                            <label aria-label="Category Input" for="category">Category*:</label>
                            <input class="min-w-0" type="text" id="category" v-model="form.category">
                        </div>
                    </div>
                    ...
                    <div class="mt-3 text-red-600" v-else-if="$page.props.errors.producer">*Please fill out all marked fields</div>
            ...
            <div aria-label="Drop Down Statement" class="">
                <button type="button" @click="timeTrackingOpen = !timeTrackingOpen" class="mt-4 bg-gradient-to-r from-red-200 via-gray-200 to-gray-200 font-bold flex justify-between items-center p-2 w-full">
                    <div class="flex">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 mr-1">
                ...
                <div v-if="accountingOpen" class="flex flex-col p-3 border bg-gray-100 w-full min-w-0">
                    <div class="flex flex-row gap-3">
                        <div class="flex flex-col grow">
                            ...
                            <input class="" id="producer" type="text" v-model="form.producer">
                        </div>
                        <div class="flex flex-col grow">
            ...
            <div aria-label="Drop Down Rating" class="">
                <button type="button" @click="ratingOpen = !ratingOpen" class="mt-4 bg-gradient-to-r from-orange-200 via-gray-200 to-gray-200 font-bold flex justify-between items-center p-2 w-full">
                    <div class="flex">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 mr-1">
...
onMounted(() => {
    ...
    if (event.ctrlKey && event.altKey && event.key === 'y') {
        ...
        form.rating_quality = '-10';
        form.rating_happyness = '-5';
        form.rating_usability = '0';
        form.rating_developement = '5';
