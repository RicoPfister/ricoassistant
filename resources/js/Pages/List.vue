...
<div v-if="!props?.list?.result">
    ...
    <table class="w-full table-fixed">
        ...
        <tr v-for="(item, index) in data?.data" :key="index" class="">
            ...
            <td class="hidden lg:table-cell text-right">{{ item.view_count <= 9999 ? item.view_count : '+9999' }}</td>
...
<div v-if="props?.list?.result == 0">No search result found for: <b>{{ props.list.search_string }}</b></div>
